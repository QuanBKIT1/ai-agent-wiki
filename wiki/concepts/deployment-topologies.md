...
## Ví dụ production: "huddle" của Grab

[[grab-multi-agent-engineering-support|Grab]] (2026) là ví dụ thực tế trộn **Multi-Agent Distributed** + **Hierarchical**: một **Classifier** định tuyến câu hỏi tới các specialist agent (Data / Code Search / On-call) chạy **tuần tự**, rồi một **Summarizer** gộp kết quả — orchestrator quản state và context handoff. Đây đúng là pattern "orchestrator + isolated specialists" mà ngành hội tụ vào năm 2026 (peer-to-peer GroupChat thường fail ở production). Human duyệt cuối ở nhánh Enhancement (xem Human Oversight Pattern bên dưới).

## Xem thêm
- [[grab-multi-agent-engineering-support]] — ví dụ production của các topology này
